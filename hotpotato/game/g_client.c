...
{
	if(ent->client->hasHotPotato)
	{
		// Do damage.
		G_Damage(ent, NULL, NULL, NULL, NULL, 
					PLAYER_POTATO_DAMAGE, DAMAGE_NO_ARMOR, MOD_SHOTGUN);
	}
...
//	char	*savedAreaBits;
	...
	//potato...
	if(client->hasBeenKilledByPotato)
	{
